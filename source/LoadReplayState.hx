...
class LoadReplayState extends MusicBeatState
{
	...
	override function create()
	{
        ...
        addWeek(['Spooky-Month', 'Spookeez', 'South', 'Eerie', 'Toadhemian-Rhapsody'], 2, ['spooky', 'spooky', 'spooky', 'spooky', 'toads']);
        addWeek(['Pico', 'Philly', 'Blammed', 'Pico-Again'], 3, ['pico']);
        ...
        for(i in 0...controlsStrings.length)
        {
            ...
            controlsStrings[i] = string.split("time")[0] + " " + (rep.replay.songDiff == 2 ? "HARD" : rep.replay.songDiff == 3 ? "BRUH" : rep.replay.songDiff == 1 ? "EASY" : "NORMAL");
        }
